...
public class CloudTracking_ implements PlugIn {
	...
	public void run(String arg) {
		...
		while (numOfIteration > 0) {
			...
			// mit Cloud-Objekten zurück gibt.
			...
			// Die folgende Methode bereitet das Verzeichnis fÃ¼r den nÃ¤chsten
			// Durchlauf vor
